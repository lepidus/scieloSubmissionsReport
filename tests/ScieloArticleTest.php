...
class ScieloArticleTest extends TestCase
{
    ...
    private $doi = '10.1234/TestArticle.1233';
    ...
    {
        $article = new ScieloArticle($this->submissionId, $this->title, $this->submitter, $this->submitterCountry, $this->doi, $this->dateSubmitted, $this->daysUntilStatusChange, $this->status, $this->authors, $this->section, $this->language, $this->finalDecision, $this->finalDecisionDate, [], $this->sectionEditor, $this->reviews, $this->lastDecision);
    ...
    {
        $article = new ScieloArticle($this->submissionId, $this->title, $this->submitter, $this->submitterCountry, $this->doi, $this->dateSubmitted, $this->daysUntilStatusChange, $this->status, $this->authors, $this->section, $this->language, $this->finalDecision, $this->finalDecisionDate, $this->editors, '', $this->reviews, $this->lastDecision);
        $messageNoEditors = __('plugins.reports.scieloSubmissionsReport.warning.noEditors');
    ...
    {
        $article = new ScieloArticle($this->submissionId, $this->title, $this->submitter, $this->submitterCountry, $this->doi, $this->dateSubmitted, $this->daysUntilStatusChange, $this->status, $this->authors, $this->section, $this->language, $this->finalDecision, $this->finalDecisionDate, $this->editors, $this->sectionEditor, [], $this->lastDecision);
    ...
    {
        $article = new ScieloArticle($this->submissionId, $this->title, $this->submitter, $this->submitterCountry, $this->doi, $this->dateSubmitted, $this->daysUntilStatusChange, $this->status, $this->authors, $this->section, $this->language, $this->finalDecision, $this->finalDecisionDate, $this->editors, $this->sectionEditor, $this->reviews, '');
    ...
    {
        $article = new ScieloArticle(1, 'Title 1', 'Paola Franchesca', 'Brasil', '10.1234/TestArticle.1', '2021-04-21', 1, 'Posted', [new SubmissionAuthor('Paola Franchesca', 'Italy', 'University of Milan')], 'Fashion Design', 'en', 'Accepted', '2021-04-23', ['Jean Paul Cardin'], 'Jean Paul Cardin', ['Accept', 'See comments'], 'Accept');

        $expectedRecord = ['1', 'Title 1', 'Paola Franchesca', 'Brasil', '10.1234/TestArticle.1', '2021-04-21', '1', 'Posted', 'Jean Paul Cardin', 'Jean Paul Cardin', 'Paola Franchesca, Italy, University of Milan', 'Fashion Design', 'en', 'Accept,See comments', 'Accept', 'Accepted', '2021-04-23', '2', '2'];
