...
class ScieloSubmissionsOPSReportTest extends TestCase
{
    ...
    private function createTestPreprints(): array
    {
        ...
        $preprint2 = new ScieloPreprint(2, "Titulo 2", "Pablo Giorgio", "Brasil", false, $submittedDateForPreprint2, 6, "Posted", array(new SubmissionAuthor("Atila", "Brazil", "USP")), "Biological", "en", "Accepted", $finalDecisionDateForPreprint2, ["Richard Feynman"], ["Neil Tyson"], "Sent to journal publication", "No DOI informed", [""], $stats);
        $preprint3 = new ScieloPreprint(3, "Titulo 3", "Pablo Giorgio", "Brasil", false, $submittedDateForPreprint3, 6, "Posted", array(new SubmissionAuthor("Atila", "Brazil", "USP")), "Biological", "en", "Accepted", $finalDecisionDateForPreprint3, ["Richard Feynman"], ["Neil Tyson"], "Sent to journal publication", "No DOI informed", [""], $stats);
